...
class APIServices {
  ...
  async bookmark(org_id, room_id, job, data) {
    if (job === 'delete') {
      return await $http.delete(
        `/org/${org_id}/rooms/${room_id}/bookmark?name=${data}`
      )
    } else if (job === 'get') {
      return await $http.get(`/org/${org_id}/rooms/${room_id}/bookmarks`)
    } else if (job == 'post') {
      return await $http.post(
        `/org/${org_id}/rooms/${room_id}/new-bookmark`,
        data
      )
    }
  }

  async allLinks(org_id, room_id) {
    return await $http.get(`/org/${org_id}/rooms/${room_id}/links`)
  }
